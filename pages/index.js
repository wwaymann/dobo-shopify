        ...
        >
          ...
          <div
            ...
            style={{
              ...
              touchAction: "pan-y",
              userSelect: "none",
              pointerEvents: "none", // el stage no maneja eventos, solo sus hijos
            }}
          >
            {/* Macetas – pivote arriba */}
            <div
              ...
              style={{
                position: "absolute",
                bottom: 0, // pegada al fondo de la escena
                left: "50%",
            ...
            <div
              ...
              style={{
                position: "absolute",
                bottom: "300px", // misma altura que ya usabas para "flotar"
                left: "50%",
                transform: "translateX(-50%)",
              ...
              <div className="mb-3 text-center">
                ...
                >
                  ...
                  <button
                    className="btn btn-outline-secondary"
                    onClick={() =>
                      setQuantity((p) => Math.min(1000, p + 1))
                    }
                  >
                    +
                  </button>
