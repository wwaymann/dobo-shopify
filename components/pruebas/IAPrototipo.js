...
export default function IAPrototipo() {
  ...
  const macetas = [
    { id: 1, name: "Maceta 01", img: "/macetas/maceta1.png" },
    { id: 2, name: "Maceta 02", img: "/macetas/maceta2.png" },
    { id: 3, name: "Maceta 03", img: "/macetas/maceta3.png" },
  ];

  const plantas = [
    { id: 1, name: "Planta 01", img: "/plantas/planta1.png" },
    { id: 2, name: "Planta 02", img: "/plantas/planta2.png" },
    { id: 3, name: "Planta 03", img: "/plantas/planta3.png" },
  ];
